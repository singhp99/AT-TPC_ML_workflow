...
<figure style="display: flex; justify-content: space-between;">
    <img src="../imgs/one_track.png" alt="One track" style="width:30%;"/>
    <img src="../imgs/two_tracks.png" alt="Two track" style="width:30%;"/>
    <img src="../imgs/three_tracks.png" alt="Three track" style="width:30%;"/>
</figure>

<figure style="display: flex; justify-content: space-between;align-items: center;">
    <img src="../imgs/four_tracks.png" alt="Four track" style="width:30%;"/>
    <img src="../imgs/five_tracks.png" alt="Five track" style="width:30%;"/>
</figure>
...
<figure style="display: flex; justify-content: center;">
    <img src="../imgs/convgif.gif.webp" alt="Config" style="width:70%;"/>
</figure>
...
<figure style="display: flex; justify-content: center;">
    <img src="../imgs/attpc_tensor.png" alt="Config" style="width:70%;"/>
</figure>
...
<figure style="display: flex; justify-content: center;">
    <img src="../imgs/incorrect_analysis.png" alt="Config" style="width:70%;"/>
</figure>
